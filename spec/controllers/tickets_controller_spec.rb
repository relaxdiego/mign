...
#     it "assigns all items as @tickets" do
...
#     it "assigns the requested item as @ticket" do
#       item = Item.create! valid_attributes
...
#
#   describe "GET new" do
#     it "assigns a new item as @ticket" do
...
#       end
#
#       it "assigns a newly created item as @ticket" do
#         post :create, {:item => valid_attributes}, valid_session
...
#       it "assigns a newly created but unsaved item as @ticket" do
...
#
#     describe "with invalid params" do
#       it "assigns the item as @ticket" do
#         item = Item.create! valid_attributes
#         # Trigger the behavior that occurs when invalid params are submitted
#         Item.any_instance.stub(:save).and_return(false)
